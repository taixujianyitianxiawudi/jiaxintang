...
var rules = {
    isAuthenticatedUser: graphql_shield_1.rule()(function (_parent, _args, context) {
        var userId = utils_1.getUserId(context);
        return Boolean(userId);
    }),
    isPostOwner: graphql_shield_1.rule()(function (_parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
        var userId, author;
